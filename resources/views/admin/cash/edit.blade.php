                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.exam')}}">الامتحانات </a>
                            </li>
                            <li class="breadcrumb-item active">تعديل امتحان
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.exam.update',$exam -> id)}}" method="POST"
                                        ...
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-home"></i> بيانات الامتحان </h4>
                                            <div class="row">
                                                <div class="col-md-6">
