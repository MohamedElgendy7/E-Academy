                ...
                <div class="col-12 col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">اعلي درجات اخر اختبار</h4>
                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-de mb-0">
                                    ...
                                    <tbody>
                                        {{-- (cc BTC-alt) class for be green line for red use (bg-danger
                                        bg-lighten-5) --}}
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <center>
                                <img src="timetable.jpg" style="width:537px" alt="جدول المواعيد">
                            </center>
                        </div>
                    </div>
                </div>
