                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.doc.index')}}">الملفات </a>
                            </li>
                            <li class="breadcrumb-item active">اضافة ملف
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card border-primary">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.doc.store')}}" method="POST">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="projectinput1">اسم الملف</label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="projectinput1">رابط ملف </label>
                                                    <input type="text" value="" id="name" class="form-control"
