                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> اسم الصف
                                                        </label>
                                                        <input type="text" id="name" class="form-control"
                                                            placeholder="  " value="{{$Grade -> name}}" name="name">
                                                        @error("name")
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="main_category_id" class="select2 form-control">
                                                            <optgroup label="من فضلك أختر القسم ">
                                                                ...
                                                                <option value="{{$category -> id }}" @if($Grade->
                                                                    main_category->id ==$category -> id) selected
                                                                    @endif>{{$category ->
                                                                    name}}</option>
                                                                @endforeach
                                                                @endif
