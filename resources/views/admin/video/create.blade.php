...
@section('title','أضافة فيديو جديد')
@section('content')
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.video.index')}}">الفيديوهات </a>
                            </li>
                            <li class="breadcrumb-item active">اضافة فيديو
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card border-primary">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> اضافة فيديو </h4>
